...
function EmptyContainer({
  ...
  return (
    ...
    >
      <div className="flex size-32 items-center justify-center rounded-lg border border-gray-4 bg-gray-1 shadow-sm">
        <span className="flex flex-col items-center space-y-1 text-center text-gray-10">
          {children}
        </span>
      </div>
    </div>
