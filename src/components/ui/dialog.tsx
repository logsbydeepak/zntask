...
export const Portal = ({ children, ...props }: Dialog.DialogPortalProps) => (
  <Dialog.Portal>
    <Dialog.Overlay
      {...props}
      className={cn(
        'fixed inset-0 z-30 bg-newGray-1/50 backdrop-blur-sm',
...
>(({ children, className, ...props }, ref) => (
  <Dialog.Content
    ...
    ref={ref}
    className={cn(
      'fixed bottom-0 z-50 w-full rounded-t-xl border border-newGray-4 bg-newGray-1 p-6 drop-shadow-xl duration-1000',
